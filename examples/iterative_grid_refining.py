...
from acrobotics.recources.path_on_table import path_pos_tol, path_ori_free, scene2, scene
...
res = cart_to_joint_iterative(robot, path, scene, num_samples=500, max_iters=5)
# print(res)
