...
tf0 = np.array([[1, 0, 0, XPOS - 0.20],
                [0, 1, 0, YPOS],
                [0, 0, 1, ZPOS - 0.05],
                [0, 0, 0, 1]])
tf1 = np.array([[1, 0, 0, XPOS],
                [0, 1, 0, YPOS],
                [0, 0, 1, ZPOS + TICKNESS / 2],
                [0, 0, 0, 1]])

tf2 = np.array([[1, 0, 0, XPOS + WIDTH / 2 - TICKNESS / 2],
                [0, 1, 0, YPOS],
                [0, 0, 1, ZPOS + WIDTH / 2 + TICKNESS],
                [0, 0, 0, 1]])


obstacle_tf = np.array([[1, 0, 0, XPOS - WIDTH / 4],
                        [0, 1, 0, YPOS],
                        [0, 0, 1, ZPOS + TICKNESS + HEIGHT / 2],
                        [0, 0, 0, 1]])

scene = Collection([table, l_bottom, l_top, obstacle],
                   [tf0, tf1, tf2, obstacle_tf])
